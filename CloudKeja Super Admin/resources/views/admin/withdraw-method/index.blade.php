        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="woodland-card-header">
                    <h3>@lang('Withdraw Method')</h3>
                    @can('withdraw-methods-create')
                        <a href="{{ route('admin.withdraw-methods.create') }}" class="modal-btn d-print-none"><i
                                class="fal fa-plus-circle"></i> @lang('Add Method')</a>
                    @endcan
                </div>
                <div class="woodland-card">
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div>
                            <form action="{{ route('admin.withdraw_methods.filter') }}" method="post"
                                class="filter-form form-inline d-flex align-items-center gap-3 flex-wrap"
                                table="#withdraw-method-data">
                                @csrf
                        ...
                        <div class="d-flex align-items-center gap-3 d-print-none">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li><a class="dropdown-item  export-drop-item" href="{{ route('admin.withdraw-methods.csv') }}"><img
                                                src="{{ asset('backend/assets/img/icon/csv.svg') }}" /> {{__('Csv')}} </a></li>
                                    <li><a class="dropdown-item export-drop-item" href="{{ route('admin.withdraw-methods.excel') }}"><img
                    ...
                    <div class="delete-item delete-show d-none">
                        <div class="delete-item-show">
                            ...
                            <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                data-url="{{ route('admin.withdraw_methods.delete-all') }}">{{ __('Delete') }}</button>
                        </div>
                    </div>
                        ...
                        <table class="table woodland-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Charge')</th>
                                    <th class="d-print-none">@lang('Status')</th>
                                    <th class="d-print-none">@lang('Action')</th>
                                </tr>
                            </thead>
                            <tbody id="withdraw-method-data">
                                @include('admin.withdraw-method.datas')
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="woodladn-pagination-wrapper">
                        <nav class="woodland-pagination">
                            <ul class="pagination">
                                <li class="page-item">{{ $withdrawMethods->links() }}</li>
                            </ul>
                        </nav>
                    </div>
...
@push('modal')
    @include('admin.withdraw-method.view')
