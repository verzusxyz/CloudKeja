        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="woodland-card-header">
                    ...
                    @can('expenses-create')
                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-expense-modal" class="modal-btn d-print-none"><i class="fal fa-plus-circle"></i>{{ __('Add New') }}</a>
                    @endcan
                </div>
                ...
                <div class="woodland-card">
                    <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-3 d-print-none">
                       <div class="d-flex align-items-end flex-wrap gap-3">
                           <form action="{{ route('admin.expenses.filter') }}" method="post" class="filter-form-expense form-inline d-flex align-items-center gap-3 flex-wrap" table="#expenses-data">
                               @csrf
                           ...
                           <form action="{{ route('admin.expenses.filter') }}" method="post"
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <form action="{{ route('admin.expenses.filter') }}" method="post" class="filter-form-expense form-inline d-flex align-items-end gap-3 flex-wrap" table="#expenses-data">
                               @csrf
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li>
                                        <a class="dropdown-item export-drop-item" href="{{ route('admin.expenses.csv') }}">
                                            <img src="{{ asset('backend/assets/img/icon/csv.svg') }}" /> {{__('Csv')}}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item export-drop-item" href="{{ route('admin.expenses.excel') }}">
                                            <img src="{{ asset('backend/assets/img/icon/esv.svg') }}" /> {{__('Excel')}}
                                        </a>
                                    </li>
                                    <li>
                                        <a  class="dropdown-item export-drop-item print-window">
                                            <img src="{{ asset('backend/assets/img/icon/print.svg') }}" /> {{__('Print')}}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="delete-item delete-show d-none">
                        <div class="delete-item-show">
                            ...
                            <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                data-url="{{ route('admin.expenses.delete-all') }}">{{ __('Delete') }}</button>
                        </div>
                    </div>
