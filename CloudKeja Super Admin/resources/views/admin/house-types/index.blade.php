        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="woodland-card-header">
                    <h3>{{ __('House Type List') }}</h3>
                    @can('house-types-create')
                        <a href="" data-bs-toggle="modal" data-bs-target="#add-house-type-modal" class="modal-btn"><i
                ...
                <div class="woodland-card">
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div>
                            <form action="{{ route('admin.house-types.filter') }}" method="post"
                                class="filter-form form-inline d-flex align-items-center gap-3 flex-wrap"
                                table="#house-types-data">
                                @csrf
                    ...
                    <div class="delete-item delete-show d-none">
                        <div class="delete-item-show">
                            ...
                            <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                data-url="{{ route('admin.house-types.delete-all') }}">{{ __('Delete') }}</button>
                        </div>
                    </div>
                    ...
                    <div class="responsibe-table">
                        <table class="table woodland-table">
                            ...
                            <tbody id="house-types-data">
                                @include('admin.house-types.datas')
                            </tbody>
                        </table>
                    </div>
                    <div class="woodladn-pagination-wrapper">
                        ...
                        <nav class="woodland-pagination">
                            <ul class="pagination">
                                <li class="page-item">{{ $house_types->links() }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
@push('modal')
    ...
    @include('admin.house-types.create')
    @include('admin.house-types.edit')
@endpush
