                ...
                <div class="woodland-card">
                        ...
                        <div class="d-flex align-items-center gap-3 d-print-none">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li>
                                        <a class="dropdown-item export-drop-item" href="{{ route('admin.withdraw-request.csv') }}">
                                            <img src="{{ asset('backend/assets/img/icon/csv.svg') }}" /> {{__('Csv')}}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item export-drop-item" href="{{ route('admin.withdraw-request.excel') }}">
                                            <img src="{{ asset('backend/assets/img/icon/esv.svg') }}" /> {{__('Excel')}}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item print-window export-drop-item">
                    ...
                    <div class="responsibe-table table-height">
                        <table class="table woodland-table">
                            ...
                            <tbody id="withdraw-request-data">
                                @include('admin.withdrawals.datas')
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="woodladn-pagination-wrapper">
                        <nav class="woodland-pagination">
                            <ul class="pagination">
                                <li class="page-item">{{ $withdraws->links() }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
