...
@section('main_content')
    <div class="woodland-section-container">
        <form action="{{ route('admin.properties.store') }}" method="post" id="regForm" enctype="multipart/form-data"
                ...
                <div>
                    <div class="chart-table">
                        ...
                        <div class="add-property-progress">
                            <ul id="stepList">
                                <li class="step active"><span class="numbering">@lang('1')</span>@lang('Basic Information')
                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 property_type_div">
                                        ...
                                        <select class="form-control property_type reset_val" name="property_type">
                                            ...
                                            <option value="Shop lot">@lang('Shop lot')</option>
                                    ...
                                    <div class="col-lg-12 property_size_div">
                                        ...
                                        <input type="number" class="form-control property_size reset_val"
                                            name="property_info[property_size]" placeholder="Enter Property Size">
                                    </div>
                                    ...
                                    <div class="d-flex align-item-center flex-wrap justify-content-between">
                                        ...
                                        <div
                                            class="custom-control d-flex align-items-center justify-content-start gap-1 facilities_div">
                                            <input type="checkbox" class=" form-check-input m-0" id="selectAllFacilities">
                                    ...
                                    <div class="d-flex align-item-center justify-content-between flex-wrap mt-4">
                                        ...
                                        <div class="custom-control d-flex align-items-center justify-content-start gap-1 ">
                                            <input type="checkbox" class=" form-check-input m-0" id="selectAllAmenities">
                            ...
                            <div class="woodland-form-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 monthly_rent_div">
                                        <label class="required">@lang('Monthly Rent')
