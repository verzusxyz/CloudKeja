...
@section('main_content')
    <div class="woodland-section-container">
        <form action="{{ route('admin.properties.update', $property->id) }}" method="post" id="regForm"
                ...
                <div>
                    <div class="chart-table">
                        ...
                        <div class="add-property-progress">
                            <ul id="stepList">
                                <li class="step"><span class="numbering">@lang('1')</span>@lang('Basic Information')</li>
                                <li class="step"><span class="numbering">@lang('2')</span>@lang('Property Details')</li>
                                <li class="step"><span class="numbering">@lang('3')</span>@lang('Description & Pricing')</li>
                                <li class="step"><span class="numbering">@lang('4')</span>@lang('Contact')</li>
                                <li class="step"><span class="numbering">@lang('5')</span>@lang('Photos')</li>
                                <li class="step"><span class="numbering">@lang('6')</span>@lang('Successfully Submitted')</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="wizard-tab-form">
                            ...
                            <div class="woodland-form-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <label>{{ __('Select Landlord') }}</label>
                                        <select class="form-control" name="landlord_id" required>
                                            @foreach ($landlords as $landlord)
                                                <option value="{{ $landlord->id }}" @selected($landlord->id == $property->landlord_id)>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 building_name_div">
                                        ...
                                        <input type="text" class="form-control building_name reset_val"
                                            name="building_name" value="{{ $property->building_name }}"
                                    ...
                                    <div class="col-lg-12 house_type_div">
                                        ...
                                        <select class="form-control house_type reset_val" name="house_type_id">
                                            ...
                                            @foreach ($house_types as $house_type)
                                                <option value="{{ $house_type->id }}" @selected($house_type->id == $property->house_type_id)>
                                    ...
                                    <div class="col-lg-12 property_type_div">
                                        ...
                                        <select class="form-control property_type" name="property_type">
                                            ...
                                            <option @selected(($property->propertyDetail->property_type ?? '') == 'Shop lot') value="Shop lot">@lang('Shop lot')</option>
                                            <option @selected(($property->propertyDetail->property_type ?? '') == 'Warehouse / Factory') value="Warehouse / Factory">
                                                @lang('Warehouse / Factory')</option>
                                            <option @selected(($property->property_type ?? '') == 'Hotel / Resort') value="Hotel / Resort">@lang('Hotel / Resort')</option>
                                    ...
                                    <div class="col-lg-12 land_size_div">
                                        ...
                                        <input type="number" class="form-control land_size reset_val"
                                            name="property_info[land_size]"
                                            value="{{ $property->propertyDetail->property_info['land_size'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 unit_lot_size_div">
                                        ...
                                        <input type="number" class="form-control unit_lot_size reset_val"
                                            name="room_info[unit_size]"
                                            value="{{ $property->room_info['unit_size'] ?? '' }}"
                                            placeholder="@lang('Enter Unit/Lot Size')">
                                    </div>
                                    <div class="col-lg-12 unit_number_div">
                                        <label>@lang('Unit Number')</label>
                                        <input type="text" class="form-control unit_number reset_val"
                                            name="property_info[unit_number]"
                                            value="{{ $property->propertyDetail->property_info['unit_number'] ?? '' }}"
                                            placeholder="@lang('Enter Unit Number')">
                                    </div>
                                    ...
                                    <div class="col-lg-12 room_residential_type_div">
                                        ...
                                        <select class="form-control room_residential_type reset_val" name="residential_type">
                                            <option value="">{{ __('Select Residential Type') }}</option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Condo / Services residence / Penthouse')
                                                value="Condo / Services residence / Penthouse"> {{__('Condo/Services residence/Penthouse')}} </option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Apartment / Flat')
                                                value="Apartment / Flat"> {{__('Apartment/Flat')}} </option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Houses')
                                                value="Houses"> {{__('Houses')}} </option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Shoplot')
                                                value="Shoplot"> {{__('Shoplot')}} </option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Sharing a house / Flat')
                                                value="Sharing a house / Flat"> {{__('Sharing a house/Flat')}} </option>
                                            <option @selected(($property->propertyDetail->residential_type ?? '') == 'Others')
                                    ...
                                    <div class="col-lg-12 floor_range_div">
                                        ...
                                        <select class="form-control floor_range reset_val" name="room_info[floor_rang]">
                                            ...
                                            <option value="High" @selected($property->room_info['floor_rang'] ?? '' == 'High')>{{ __('High') }}
                                            </option>
                                            <option value="Medium" @selected($property->room_info['floor_rang'] ?? '' == 'Medium')>{{ __('Medium') }}
                                            </option>
                                            <option value="Low" @selected($property->room_info['floor_rang'] ?? '' == 'Low')>{{ __('Low') }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-12 room_size_div">
                                        ...
                                        <input type="number" class="form-control room_size reset_val"
                                            name="room_info[room_size]"
                                            value="{{ $property->room_info['room_size'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 bedroom_div">
                                        ...
                                        <select class="form-control bedroom_div reset_val" name="room_info[bedroom]">
                                            ...
                                            <option @selected($property->room_info['bedroom'] ?? '' == '01') value="01">@lang('01')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '02') value="02">@lang('02')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '03') value="03">@lang('03')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '04') value="04">@lang('04')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '05') value="05">@lang('05')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '06') value="06">@lang('06')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '07') value="07">@lang('07')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '08') value="08">@lang('08')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '09') value="09">@lang('09')
                                            </option>
                                            <option @selected($property->room_info['bedroom'] ?? '' == '10') value="10">@lang('10')
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-12 bathroom_div">
                                        ...
                                        <select class="form-control bathroom reset_val" name="room_info[bathroom]">
                                            ...
                                            <option @selected($property->room_info['bathroom'] ?? '' == '01') value="01">@lang('01')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '02') value="02">@lang('02')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '03') value="03">@lang('03')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '04') value="04">@lang('04')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '05') value="05">@lang('05')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '06') value="06">@lang('06')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '07') value="07">@lang('07')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '08') value="08">@lang('08')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '09') value="09">@lang('09')
                                            </option>
                                            <option @selected($property->room_info['bathroom'] ?? '' == '10') value="10">@lang('10')
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-12 property_size_div">
                                        ...
                                        <input type="number" class="form-control property_size reset_val"
                                            name="property_info[property_size]"
                                            value="{{ $property->propertyDetail->property_info['property_size'] ?? '' }}"
                                            placeholder="@lang('Enter Property Size')">
                                    </div>
                                    ...
                                    <div class="col-lg-12 furnishing_div">
                                        ...
                                        <select class="form-control furnishing reset_val" name="furnishing">
                                            <option @selected($property->propertyDetail->furnishing == 'Fully Furnished') value="Fully Furnished">
                                                @lang('Fully Furnished')</option>
                                            <option @selected($property->propertyDetail->furnishing == 'Partially Furnished') value="Partially Furnished">
                                                @lang('Partially Furnished')</option>
                                            <option @selected($property->propertyDetail->furnishing == 'Not Furnished') value="Not Furnished">@lang('Not Furnished')
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="number" class="form-control m-0 reset_val" name="security_deposit"
                                            placeholder="@lang('Enter Security Deposit')" value="{{ $property->security_deposit }}">
                                    ...
                                    <div class="col-lg-12 mt-4 utility_deposit_div">
                                        ...
                                        <input type="number" class="form-control m-0 utility_deposit reset_val"
                                            ...
                                            value="{{ $property->utility_deposit }}">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="property_info[property_title]"
                                            value="{{ $property->propertyDetail->property_info['property_title'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 property_rent_div">
                                        ...
                                        <input type="number" name="rent_info[property_rent]"
                                            value="{{ $property->rent_info['property_rent'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 monthly_rent_div">
                                        ...
                                        <input type="number" name="rent_info[monthly_rent]"
                                            value="{{ $property->rent_info['monthly_rent'] ?? '' }}"
                                            class="form-control monthly_rent reset_val" placeholder="@lang('Enter monthly rent')" required>
                                    </div>
                                    <div class="col-lg-12 rental_period_div">
                                        ...
                                        <select class="form-control rental_period reset_val"
                                            ...
                                            <option value="6 Month" @selected($property->rent_info['rental_period'] ?? '' == '6 Month')>@lang('6 Month')
                                            </option>
                                            <option value="1 Year" @selected($property->rent_info['rental_period'] ?? '' == '1 Year')>@lang('1 Year')
                                            </option>
                                            <option value="1.5 Years" @selected($property->rent_info['rental_period'] ?? '' == '1.5 Years')>@lang('1.5 Years')
                                            </option>
                                            <option value="2 Years" @selected($property->rent_info['rental_period'] ?? '' == '2 Years')>@lang('2 Years')
                                            </option>
                                            <option value="2.5 Years" @selected($property->rent_info['rental_period'] ?? '' == '2.5 Years')>@lang('2.5 Years')
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-12 lot_number_div">
                                        ...
                                        <input type="text" name="property_info[lot_number]"
                                            value="{{ $property->propertyDetail->property_info['lot_number'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 address_div">
                                        ...
                                        <input type="text" class="form-control reset_val" name="address_info[address]"
                                            value="{{ $property->address_info['address'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 city_div">
                                        ...
                                        <input type="text" class="form-control reset_val" name="address_info[city]"
                                            value="{{ $property->address_info['city'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 state_div">
                                        ...
                                        <input type="text" class="form-control reset_val" name="address_info[state]"
                                            value="{{ $property->address_info['state'] ?? '' }}"
                                    ...
                                    <div class="col-lg-12 postcode_div">
                                        ...
                                        <input type="number" class="form-control reset_val"
                                            name="address_info[postcode]"
                                            value="{{ $property->address_info['postcode'] ?? '' }}"
                                            placeholder="@lang('Enter postcode')">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" class="form-control m-0 reset_val" name="full_name"
                                            value="{{ $property->propertyDetail->full_name ?? '' }}"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="number" id="phone" class="form-control reset_val"
                                            name="phone" value="{{ $property->propertyDetail->phone ?? '' }}"
                                            placeholder="@lang('Enter whatsapp number')" required>
                                    </div>
                                    <div class="col-lg-12">
                                        <label>@lang('Email Address')</label>
                                        <input type="email" name="email" class="form-control reset_val"
                                            value="{{ $property->propertyDetail->email ?? '' }}"
                        ...
                        <div class="wizard-tab-form">
                            <div  id="dynamic-cover-image-area" class="add-photo-grid">
                                <div class="add-photo-items">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->cover_image[0] ?? 'backend/assets/img/property-img/add-photo/1.png') }}"
                                        alt="">
                                ...
                                <div class="add-photo-items room_category">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->propertyDetail->living_image ?? 'backend/assets/img/property-img/add-photo/2.png') }}"
                                        alt="">
                                    <img class="d-none default-img mt-4"
                                ...
                                <div class="add-photo-items room_category">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->propertyDetail->bedroom_image ?? 'backend/assets/img/property-img/add-photo/3.png') }}"
                                        alt="">
                                    <img class="d-none default-img mt-4"
                                ...
                                <div class="add-photo-items room_category">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->propertyDetail->kitchen_image ?? 'backend/assets/img/property-img/add-photo/4.png') }}"
                                        alt="">
                                    <img class="d-none default-img mt-4"
                                ...
                                <div class="add-photo-items room_category">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->propertyDetail->bathroom_image ?? 'backend/assets/img/property-img/add-photo/5.png') }}"
                                        alt="">
                                    <img class="d-none default-img mt-4"
                                ...
                                <div class="add-photo-items room_category">
                                    ...
                                    <img class="image-preview mt-4"
                                        src="{{ asset($property->propertyDetail->floorplan_image ?? 'backend/assets/img/property-img/add-photo/6.png') }}"
                                        alt="">
                                    <img class="d-none default-img mt-4"
                            ...
                            <div class="col-lg-12 mt-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label for="toggle-term" class="mb-0">@lang('I agree with Terms & Conditions')</label>
                                </div>
                            </div>
                        </div>
