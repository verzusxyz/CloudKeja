            ...
            <div class="col-lg-12">
                ...
                <div class="woodland-card">
                    ...
                    <div class="table-header justify-content-center border-0 d-none d-block d-print-block text-center">
                        <h4 class="mt-2">{{ __('Transaction History') }}</h4>
                    </div>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li><a class="dropdown-item  export-drop-item"
                                            href="{{ route('admin.transactions.csv') }}"><img
                                                src="{{ asset('backend/assets/img/icon/csv.svg') }}" /> {{__('Csv')}} </a></li>
                                    <li><a class="dropdown-item export-drop-item"
                                            href="{{ route('admin.transactions.excel') }}"><img
                    ...
                    <div class="responsibe-table">
                        <table class="table woodland-table">
                            ...
                            <tbody id="transaction-data">
                                @include('admin.transactions.datas')
                            </tbody>
                        </table>
                    </div>
...
@push('modal')
    @include('admin.transactions.view')
@endpush
