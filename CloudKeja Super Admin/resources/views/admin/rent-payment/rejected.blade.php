{{-- Cancel Renting Modal --}}
<div class="modal fade" id="rent-payment-reject-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <div class="custom-modal">
                    ...
                    <form action="" method="post" class="ajaxform_instant_reload rentPaymentRejectForm">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
