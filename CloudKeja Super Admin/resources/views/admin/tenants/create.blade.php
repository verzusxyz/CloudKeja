...
@section('main_content')
    <div class="woodland-section-container">
        <div class="woodland-card">
            ...
            <form action="{{ route('admin.tenants.store') }}" method="POST" class="ajaxform_instant_reload">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control reset_val" name="email" required
                    ...
                    <div class="col-lg-4">
                        <label> {{__('City')}} </label>
                        <input type="text" class="form-control" name="address_info[city]" placeholder="Enter city"
                            value="">
                    </div>

                    <div class="col-lg-4">
                        <label> {{__('State')}} </label>
                        <input type="text" class="form-control" name="address_info[state]" placeholder="Enter state"
                            value="">
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control " name="mykad_id"
                            placeholder="{{ __('Enter NID/Passport Id') }}">
                    </div>
                    ...
                    <div class="col-lg-4">
                        <label> {{__('State')}} </label>
                        <input type="text" class="form-control" name="workplace[state]" placeholder="Enter state"
                            value="">
                    </div>
                    ...
                    <div class="row" id="vehicles-container">
                        ...
                        <div class="col-lg-4 mt-4">
                            ...
                            <input type="number" class="form-control" name="vehicles_info[0][reg_no]"
                                placeholder="Enter Plate number">
                        </div>

                        <div class="col-lg-4 mt-4">
                            <label> {{__('Vehicles Brand')}} </label>
                            <input type="text" class="form-control" name="vehicles_info[0][brand]"
