<div class="modal fade" id="security-deposits-approve-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h6 class="text-black">{{ __('Approved Security Deposit') }}</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body ">
                <div class="custom-modal">
                    <form action="" method="post" class="ajaxform_instant_reload securityDepositApproveForm">
                        <div class="row">
                            ...
                            <div class="download-pdf-container pr-3 mt-3">
                                ...
                                <a id="security_payment_receipt" href="" class="download-icon-container">
