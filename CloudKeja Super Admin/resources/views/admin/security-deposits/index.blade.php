                ...
                <div class="woodland-card">
                        ...
                        <div class="d-flex align-items-center gap-3 d-print-none">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li><a class="dropdown-item  export-drop-item" href="{{ route('admin.security-deposits.csv') }}"><img
                                                src="{{ asset('backend/assets/img/icon/csv.svg') }}" /> {{__('Csv')}} </a></li>
                                    <li><a class="dropdown-item export-drop-item" href="{{ route('admin.security-deposits.excel') }}"><img
                    ...
                    <div class="responsibe-table table-height">
                        <table class="table woodland-table">
                            ...
                            <tbody id="security-deposit-data">
                                @include('admin.security-deposits.datas')
                            </tbody>
                        </table>
                    </div>
...
@push('modal')
    @include('admin.security-deposits.rejected')
    @include('admin.security-deposits.approved')
@endpush
