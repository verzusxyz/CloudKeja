                                    ...
                                    <form action="{{ route('payments-gateways.payment', ['plan_id' => $plan->id, 'gateway_id' => $gateway->id]) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="payment-list-table">
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                @php
                                                    $amount = convert_money($plan->total_amount, $gateway->currency);
                                                @endphp
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $plan->property->propertyDetail->property_info['property_title'] ?? '' }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __('Price') }}</th>
                                                    <td>{{ currency_format($plan->total_amount, currency : $gateway->currency) }}</td>
                                                </tr>
                                                <tr>
