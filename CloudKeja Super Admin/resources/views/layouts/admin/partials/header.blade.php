                ...
                <div class="notifications dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="notification-footer">
                            <a class="text-red" href="{{ route('admin.notifications.index') }}">@lang('View all notifications')</a>
                        </div>
                    </div>
                </div>
            @endif
                ...
                <a href="#" data-bs-toggle="dropdown">
                    <div class="d-flex align-items-center justify-content-center gap-2 profile-drop-btn">
                        <img src="{{ asset(auth()->user()->image ?? 'backend/assets/img/profile/use.png') }}"
                            alt="Profile">
                        <p> {{ auth()->user()->name ?? 'Sahidul Islam' }} </p>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <img class="cache-clear" src="{{ asset('backend/assets/img/icon/broom.png') }}" alt=""> {{ __('Cache Clear') }}
                        </a>
                    </li>
                    <li>
