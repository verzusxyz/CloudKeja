<footer class="container-fluid footer-section d-print-none d-flex align-items-center justify-content-center justify-content-sm-between flex-wrap py-3 ms-0 bg-white">
