        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="woodland-card-header">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-income-modal"
                ...
                <div class="woodland-card">
                    ...
                    <div class="mb-3 d-flex align-items-end justify-content-between flex-wrap gap-3 d-print-none">
                        <div class="d-flex gap-3 align-items-end">
                            <form action="{{ route('landlord.incomes.filter') }}" method="post"
                            ...
                            <form action="{{ route('landlord.incomes.filter') }}" method="post"
                                class="filter-form-income form-inline d-flex align-items-end gap-3 flex-wrap"
                                table="#incomes-data">
                                @csrf
                                ...
                                <div id="custom-date-range" class="d-none d-flex align-items-end gap-3">
                                    <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <form action="{{ route('landlord.incomes.filter') }}" method="post" class="filter-form"
                                table="#incomes-data">
                                @csrf
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li><a class="dropdown-item  export-drop-item" href="{{ route('landlord.incomes.csv') }}"><img
                                                src="{{ asset('backend/assets/img/icon/csv.svg') }}" />
                                            {{ __('Csv') }} </a></li>
                                    <li><a class="dropdown-item export-drop-item" href="{{ route('landlord.incomes.excel') }}"><img
                    ...
                    <div class="delete-item delete-show d-none">
                        <div class="delete-item-show">
                            ...
                            <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                data-url="{{ route('landlord.incomes.delete-all') }}">{{ __('Delete') }}</button>
                        </div>
                    </div>
                    ...
                    <div class="responsibe-table">
                        <table class="table woodland-table">
                            ...
                            <tbody id="incomes-data">
                                @include('landlord.incomes.datas')
                            </tbody>
                        </table>
                    </div>
...
@push('modal')
    @include('landlord.incomes.create')
    @include('landlord.incomes.edit')
