            ...
            <div class="col-lg-12">
                ...
                <div class="woodland-card">
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div>
                            <form action="{{ route('landlord.income-categories.filter') }}" method="post"
                        ...
                        <form action="{{ route('landlord.income-categories.filter') }}" method="post" class="filter-form"
                            table="#income-categories-data">
                            @csrf
                    ...
                    <div class="delete-item delete-show d-none">
                        <div class="delete-item-show">
                            ...
                            <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                data-url="{{ route('landlord.income-categories.delete-all') }}">{{ __('Delete') }}</button>
                        </div>
                    </div>
                    ...
                    <div class="responsibe-table">
                        <table class="table woodland-table">
                            ...
                            <tbody id="income-categories-data">
                                @include('landlord.income-categories.datas')
                            </tbody>
                        </table>
                    </div>
...
@push('modal')
    @include('landlord.income-categories.create')
    @include('landlord.income-categories.edit')
