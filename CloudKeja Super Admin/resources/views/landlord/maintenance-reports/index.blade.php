                ...
                <div class="woodland-card">
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        ...
                        <div class="d-flex align-items-center gap-3 d-print-none">
                            <form action="{{ route('landlord.maintenance-reports.filter') }}" class="filter-form" method="POST" table="#maintenance-reports-data">
                                @csrf
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu export-dropdown">
                                    <li><a class="dropdown-item  export-drop-item"
                                            href="{{ route('landlord.maintenance-reports.csv') }}"><img
                                                src="{{ asset('backend/assets/img/icon/csv.svg') }}" />
                                            {{ __('Csv') }} </a></li>
                                    <li><a class="dropdown-item export-drop-item"
                                            href="{{ route('landlord.maintenance-reports.excel') }}"><img
                    ...
                    <div class="responsibe-tablee">
                        <table class="table woodland-table">
                            ...
                            <tbody id="maintenance-reports-data">
                                @include('landlord.maintenance-reports.datas')
                            </tbody>
                        </table>
                    </div>
                    <div class="woodladn-pagination-wrapper">
                        <nav class="woodland-pagination">
                            <ul class="pagination">
                                <li class="page-item">{{ $maintenances->links() }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
