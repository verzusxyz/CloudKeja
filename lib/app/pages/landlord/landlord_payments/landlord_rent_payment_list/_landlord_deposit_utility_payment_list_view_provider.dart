part of 'landlord_rent_payment_list_view.dart';

class LandlordRentPaymentListViewNotifier extends ChangeNotifier {
  LandlordRentPaymentListViewNotifier(this._repo) {
...
final landlordRentPaymentListViewProvider = ChangeNotifierProvider.autoDispose(
  (ref) => LandlordRentPaymentListViewNotifier(
