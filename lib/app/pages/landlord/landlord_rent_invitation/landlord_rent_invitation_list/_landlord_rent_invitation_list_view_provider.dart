part of 'landlord_rent_invitation_list_view.dart';

class LandlordRentInvitationListViewNotifier extends ChangeNotifier {
  LandlordRentInvitationListViewNotifier(this._repo) {
...
final landlordRentInvitationListViewProvider =
    ChangeNotifierProvider.autoDispose(
  (ref) => LandlordRentInvitationListViewNotifier(
