...
part '_tenant_application_list_view_provider.dart';

@RoutePage()
class TenantApplicationListView extends ConsumerWidget {
  const TenantApplicationListView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(tenantApplicationListViewProvider);
                              ...
                              return RetryButtons.scrollView(
                                ...
                                context.t.exceptions.noApplicationFoundHint
                                  ...
                                  subject: context.t.exceptions
                                      .noApplicationFoundHint.subjects.tenant,
                                ),
                                onRetry: () => Future.sync(
                                  controller.pagingController.refresh,
                                ),
