part of 'tenant_application_list_view.dart';

class TenantApplicationListViewNotifier extends ChangeNotifier {
  TenantApplicationListViewNotifier(this._repo) {
...
final tenantApplicationListViewProvider = ChangeNotifierProvider.autoDispose(
  (ref) => TenantApplicationListViewNotifier(
